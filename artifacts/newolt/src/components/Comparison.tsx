...
const comparisonData = [
  {
    ...
    newolt: "Starts at $49/month",
    others: "$69–$165+/month",
  },
  {
    feature: "Hardware Required",
    newolt: "None — use your own device",
    others: "Expensive proprietary terminals",
  },
  ...
  {
    feature: "QR Menu Ordering",
    newolt: "Yes, built-in",
    others: "Add-on or limited",
  },
        ...
        >
          <div className="grid grid-cols-12 border-b border-white/10 bg-white/5">
            ...
            <div className="col-span-6 md:col-span-4 p-6 text-center">
              <span className="text-xl font-bold text-muted-foreground tracking-tight opacity-70">
                Others
              </span>
            </div>
          </div>
